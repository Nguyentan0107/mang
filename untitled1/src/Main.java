public class Main {
    public static void main(String[] args) {
        ...
        ProgrammingBook programmingBook = new ProgrammingBook("java","aa","b1","ten1",50,"Khong biet");
        ...
        System.out.println("Tổng số sách ProgrammingBook có language 'java' là:...... " + sumJava(arrayBook));
        System.out.println("Số sách có giá < 100.....la:" + sumFic100(arrayBook));
    }
